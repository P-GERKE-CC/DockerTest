###CSV input###
in_csv=dummy.csv	#input csv-file (no header row,delimiter TABs !!!)
in_pos=1			#input cloumn of editing pos
in_rev=6			#input column of rev-indicator (0=fwd,1=rev)
out_n=test.csv		#name of output file (important must end with .csv)
###Calculation Parameters###
b_edit=35			#start extraction x nucleotides in front of edit
a_edit=5			#end extraction x nucleotides after edit
###Fasta input###
in_fas=E_coli.fas	#input fasta file (sequence one-line!!!)
...
paste $in_csv ext_seq_cor > $out_n  #### add column to file 
